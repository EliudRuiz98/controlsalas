...
@section('content')
        <div class="panel panel-primary">
          <div class="panel-heading text-right">
              <button id="create_event"  type="button" class="btn btn-success btn-md"><i class="fa fa-plus"></i> Solicita un centro de cómputo</button>
          </div>
          ...
          <div class="modal-dialog" >
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Reserva un centro de cómputo</h4>
              </div>
              ...
              <div class="modal-body">
                ...
                <form id="create_event_frm"  action="{{route('event')}}"  method="post" enctype="multipart/form-data"  >
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-xs-12">
                      ...
                      <!--campo event_title-->
                        <input type="text" name="event_title" id="event_title" required=""  class="form-control" placeholder="Título del evento">
                  ...
                  <div class="row">
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                      <!--campo event_start_date-->
                          <input type="text"   name="event_start_date" required="" id="event_start_date" value="" class="form-control date_pick" placeholder="Fecha inicio">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_start_time_area" style="display: none">
                        <!--                                 none-->
                        <div class="form-group">
                      <!--campo event_start_time-->
                          <input type="text"   name="event_start_time" id="event_start_time" value="12:00 AM" class="form-control time_pick" placeholder="Hora inicio">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right" >
                      <div class="col-lg-2 col-xs-2">
                        <div id="end_date_toggle">
                          ...
                          <i class="text-success fa fa-plus"></i> Fecha final</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="section row" id="end_date_area" style="display: none">
                    ...
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                                          <!--campo event_end_date-->
                          <input type="text"   name="event_end_date" id="event_end_date" value="" class="form-control date_pick" placeholder="Fecha final">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                      ...
                      <div class="col-lg-5 col-xs-12" id="event_end_time_area" style="display: none">
                        <!--                    //none-->
                                              <!--campo event_end_time-->
                        <input type="text"   name="event_end_time" id="event_end_time" value="11:59 PM" class="form-control time_pick" placeholder="Hora final">
                      </div>
                    </div>
                    <div class="pull-right">
                      <div class="col-lg-2 col-xs-2">
                        <button type="button" class="btn btn-md" onclick="remove_end_date()" style="width: 117px" > <i class="text-danger fa fa-times"></i> Eliminar</button>
                      </div>
                    </div>
                  </div>
                <!-- Campo event_description -->
                  <div class="section row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <textarea class="form-control" id="event_description" name="event_description" placeholder="Información adicional sobre la reserva" ></textarea>
                      </div>
                    </div>
                  </div>
...
<!-- Campo nombreSala -->
      <div class="form-group">
        <input type="text" class="form-control" id="nombreSala" name="nombreSala" placeholder="Nombre del centro de cómputo" required>
      </div>

<!-- Campo nombreUsuario -->
      <div class="form-group">
        <input type="text" class="form-control" id="nombreUsuario" name="nombreUsuario" placeholder="Nombre del usuario que solicita" required>
      </div>
                  ...
                  <div class="section" style="margin-top: 10px">
                    ...
                    <p class="text-right">
                        <button type="button" id="create_event_btn"  class="btn btn-primary">Guardar</button>
                    </p>
                  </div>
                  <!-- end section row -->
                </form>
              ...
              <div class="modal-body">
                ...
                <form id="edit_event_frm" action=""  method="post" enctype="multipart/form-data"  >
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-xs-12">
                      <div class="form-group">
                        <label class="">Título de la reserva</label>
                        <input type="text" name="event_title" id="edit_event_title" required=""  class="form-control" placeholder="Título de la reserva">
                      </div>
                    ...
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text"   name="event_start_date" required="" id="edit_event_start_date" value="" class="form-control date_pick" placeholder="Fecha de inicio">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                        <div id="edit_start_time_toggle" class="mt30">
                          <button type="button"  class="btn btn-md" title="Eliminar fecha de inicio"   onclick="edit_remove_start_time()"> 
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_start_time_area" style="display: block">
                        <div class="form-group">
                          ...
                          <input type="text"   name="event_start_time" id="edit_event_start_time" value="" class="form-control time_pick" placeholder="Hora de inicio">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right" >
                    ...
                    <div class="pull-left" style="width: 75%;">
                      <div class="col-lg-5 col-xs-12">
                        <div class="form-group">
                          ...
                          <input type="text"   name="event_end_date" id="edit_event_end_date" value="" class="form-control date_pick" placeholder="Fecha final">
                        </div>
                      </div>
                      <div class="col-lg-2 col-xs-2">
                      ...
                      <div class="col-lg-5 col-xs-12" id="edit_event_end_time_area" style="display: block">
                        <div class="form-group">
                          ...
                          <input type="text"   name="event_end_time" id="edit_event_end_time" value="" class="form-control time_pick" placeholder="Hora final">
                        </div>
                      </div>
                    </div>
                    <div class="pull-right">
                      <div class="col-lg-2 col-xs-2 mt30" >
                        <button type="button" class="btn btn-md" onclick="edit_remove_end_date()" style="width: 117px" > <i class="text-danger fa fa-times"></i> Eliminar</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="edit_event_description" name="event_description" placeholder="Información adicional sobre la reserva" ></textarea>
                      </div>
                    </div>
                  </div>
  ...
  <!-- Campo nombreUsuario -->
        <div class="form-group">
          <input type="text" class="form-control" id="nombreUsuario" name="nombreUsuario" placeholder="Nombre del usuario que solicita" required>
                  ...
                  <div class="section" style="margin-top: 10px">
                    <p class="text-right">
                      <button type="button" id="edit_event_btn"  class="btn btn-primary">Actualizar</button>
                    </p>
                  </div>
                  <!-- end section row -->
                </form>
