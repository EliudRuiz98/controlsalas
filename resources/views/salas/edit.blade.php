    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action">Panel</a>
                <a href="#" class="list-group-item list-group-item-action active">Lista de Centros de cómputo</a>
...
<form action="{{ url ('salas/'.$sala->idSala) }}" method="post">
    ...
    <div class="mb-3-row">
        ...
        <div class="col-sm-2">
            <input type="number" class="form-control" name="numeroDeSalaComputo" id="numeroDeSalaComputo" value="{{ $sala->numeroDeSalaComputo}}" required>
        </div>
    </div>
    ...
    <div class="mb-3-row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="nombreSalaComputo" id="nombreSalaComputo" value="{{ $sala->nombreSalaComputo}}" required>
        </div>
    </div>
    ...
    <div class="mb-3-row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="ubicacionCentroComputo" id="ubicacionCentroComputo" value="{{ $sala->ubicacionCentroComputo}}">
        </div>
    </div>
    ...
    <div class="mb-3-row">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="descripcionCentroComputo" id="descripcionCentroComputo" value="{{ $sala->descripcionCentroComputo}}">
        </div>
    </div>
...
<!-- El campo ESTADO no es visible para el usuario. -->
    ...
    <div class="mb-3-row">
        ...
        <div class="col-sm-5">
            <input type="date" class="form-control" name="fechaDeAgregadoComputo" id="fechaDeAgregadoComputo" value="{{ $sala->fechaDeAgregadoComputo}}">
        </div>
    </div>
